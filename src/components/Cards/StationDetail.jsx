...
const StationDetail = ({
  ...
  return (
    <div className="relative mx-5 my-3 w-[350px] maxWeb1:w-[440px] maxWeb2:w-[480px] maxWeb3:w-[530px] maxWeb4:w-[580px] rounded-[16px] h-[185px] maxWeb1:h-[200px] maxWeb2:h-[250px] maxWeb3:h-[300px] maxWeb4:h-[300px] overflow-hidden">
      <div
        className={`${
              ...
              return (
                <div className="flex pl-4 items-center w-[100%] gap-x-4">
                  ...
                  <div className="font-[500] font-[Quicksand] text-[1rem] w-[95%] maxWeb1:text-[1.5rem] maxWeb2:text-[1.8rem] maxWeb3:text-[2rem] maxWeb4:text-[2.2rem]  maxWeb1:w-[94%] maxWeb2:w-[93%] maxWeb3:w-[92%] maxWeb4:w-[92%]">
                    {Number(fuel.value).toFixed(2)} /{" "}
                    <span>{Number(fuel.max_value).toFixed(2)}</span>
                  </div>
                </div>
              );
            })}
